...
impl TryFrom<raw::XvdHeader> for XvdHeader {
    ...
    fn try_from(value: raw::XvdHeader) -> Result<Self, Self::Error> {
        ...
        Ok(Self {
            ...
            package_version: Version::from_fields(value.package_version.map(|n| n.get())),
            ...
            required_system_version: Version::from_fields(
                value.required_system_version.map(|n| n.get()),
            ),
